...
namespace NCalculatorLib
{
    class Parser
    {
        ...
        bool MatchExprSeqExpr(int& index, expr_seq_expr*& rst);
        ...
        bool MatchCondExpr(int& index, cond_expr*& rst);

        //C# TO C++ CONVERTER WARNING: Nullable reference types have no equivalent in C++:
        //ORIGINAL LINE: public bool MatchEqExpr(ref int index, out EqExpr? rst)
        bool MatchEqExpr(int& index, eq_expr*& rst);
        ...
        bool MatchQuoteExprSeqExpr(int& index, expr_seq_expr*& rst);
        ...
        bool MatchMulExpr(int& index, mul_expr*& rst);
        ...
        bool MatchConstExpr(int& index, const_expr*& rst);
